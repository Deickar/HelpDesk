...
<head>
    <meta charset="utf-8" />
    <title>404 - Página no encontrada | Sistema de HelpDesk</title>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center pt-4">
                        ...
                        <div class="mt-n4">
                            ...
                            <p class="text-muted mb-4">🔍 La página que estás buscando no existe o fue movida.</p>
                            <a href="{{ route('dashboard') }}" class="btn btn-success">
                                <i class="mdi mdi-home me-1"></i> Volver al Dashboard
                            </a>
                        </div>
                    </div>
                </div>
